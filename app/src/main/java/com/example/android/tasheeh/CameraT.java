        ...
        fab4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ((!fab2.isEnabled()) && Text.getText().toString().trim().length() == 0)
                    Toast.makeText(getApplicationContext(), "Please capture an image and extract text", Toast.LENGTH_SHORT).show();
                else {
                    i = new Intent(CameraT.this, VerifyByExtractedText.class);
